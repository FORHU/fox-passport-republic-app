        ...
        <v-col cols="12" xxl="11" xl="10" lg="10">
            <v-row no-gutters >
                ...
                <v-row>
                    ...
                    <v-row v-else >
                        <v-col cols="12" sm="12" md="3" lg="3" class=" pb-5 pl-3 pr-2" >
                            <v-row class="mb-n1" no-gutters >
                                <v-col class=" pr-1 pb-2 mb-n1 "  v-if="recentlyViewed[0]._id.cover_photo.length"   cols="6" v-for="(item,index) in recentlyViewed[0]._id.cover_photo" :key="index"  >
                                     <v-card @click="goToRecentlyviewed()" variant="flat" :class="getClassProp(index)"  >
                                        <v-img
                                          
                                         cover
                                         :height="sm ? '200' : xs  ? '100' :'103'"
                            ...
                            <v-row class="w-100  pb-1 pl-4   font-weight-bold">
                                    Recently Viewed
                                </v-row>
                        </v-col>
                
                        <v-col v-for="(space,index) in spaceArray" :key="index" cols="12" sm="12" md="3" lg="3">
                            <NuxtLink
                                :to="{
                            ...
                            :height="sm ? '100%' : '212'"
                             ...
                             <v-row class="w-100  pl-3 text-subtitle-2">
                               {{ (space?.favorites?.length || 0) + ' saved' }}
                             </v-row>
