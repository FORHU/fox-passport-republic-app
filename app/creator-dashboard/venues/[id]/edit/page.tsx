...
import { useHostVenueEdit } from "@/hooks/dashboards/useHostVenueEdit";

function HostVenueEditPageContent() {
...
export default function HostVenueEditPage() {
  return (
    <Suspense fallback={<div className="fixed inset-0 bg-[#02040a]" />}>
      <HostVenueEditPageContent />
    </Suspense>
  );
}
