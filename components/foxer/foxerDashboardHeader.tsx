...
import Sidebar from "@/components/foxer/Sidebar";
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-pink-100 bg-white/80 backdrop-blur-sm px-6 dark:bg-background-dark/80 dark:border-pink-900/30">
      ...
      <div className="flex items-center gap-3">
        <Button onClick={onOpen} size="sm" className="hidden sm:flex items-center gap-2 bg-primary hover:bg-primary-dark text-white rounded-full shadow-lg shadow-primary/20">
