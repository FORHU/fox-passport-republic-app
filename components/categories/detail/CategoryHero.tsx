...
export const CategoryHero: React.FC<CategoryHeroProps> = ({ category }) => {
  ...
  return (
    <div className="mb-20 relative">
      {/* Glow Effect */}
      <div className={`absolute -top-32 -left-20 w-[500px] h-[500px] bg-gradient-to-br ${gradientColors} rounded-full blur-[150px] opacity-30 pointer-events-none`}></div>
      ...
      <div className="relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="flex items-center gap-2 mb-2 text-xs font-bold tracking-wider uppercase text-gray-500">
            ...
            <span className={`inline-block text-transparent bg-clip-text bg-gradient-to-r ${gradientColors}`}>
