      ...
      <section className="reveal-on-scroll" style={{ transitionDelay: '100ms' }}>
        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/5 flex flex-col items-center justify-center py-16 px-8 text-center min-h-[300px]">
          <div className="h-16 w-16 rounded-full bg-surface-highlight flex items-center justify-center mb-4">
            <span className="material-symbols-outlined text-white/40 text-3xl">storefront</span>
          </div>
          <h4 className="font-bold text-white text-lg mb-2">Venues are for Hosts &amp; Foxers</h4>
          <p className="text-text-muted text-sm max-w-xs">
            Venue listings are available to Hosts, Foxers, and Mayors. Apply for a role to unlock this section.
          </p>
        </div>
      </section>
    );
  ...
  return (
    ...
    <section className="reveal-on-scroll" style={{ transitionDelay: '100ms' }}>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {/* Cards */}
                <Link href="/venues/bean-leaf-popup" className="contents">
                ...
                <Link href="/venues/abstract-gallery" className="contents">
                  <article className="glass-card group relative flex flex-col rounded-[2rem] overflow-hidden card-hover-effect cursor-pointer">
                    <div className="relative aspect-4/3 overflow-hidden">
                      <Image
                        alt="Art"
                ...
                <Link href="/venues/stargazing-camp" className="contents">
                  <article className="glass-card group relative flex flex-col rounded-[2rem] overflow-hidden card-hover-effect cursor-pointer">
                    <div className="relative aspect-4/3 overflow-hidden">
                      <Image
                        alt="Camping"
