...
// --- RAW DATA: Organized by Region > Province > List of Towns/Cities ---
// This is much easier to maintain than 1600+ function calls.
const PH_DATA: Record<string, Record<string, string[]>> = {
  "NCR": {
    "Metro Manila": [
  ...
  "Region XII": {
    ...
    "Sarangani": [
      "Alabel", "Glan", "Kiamba", "Maasim", "Maitum", "Malapatan", "Malunggon"
    ],
    "South Cotabato": [
...
// --- FLATTENED LIST EXPORT ---
export const ALL_LOCATIONS: LocationItem[] = Object.entries(PH_DATA).flatMap(([region, provinces]) => 
  Object.entries(provinces).flatMap(([province, towns]) => 
