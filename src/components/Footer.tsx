        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-2 gap-y-8 text-xs md:text-sm text-gray-700">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:underline hover:text-gray-900">Trust & Safety</a></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:underline hover:text-gray-900">Travel Blog</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Collections</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Gift Cards</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Refer a Friend</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Forum</a></li>
            </ul>
          </div>

          {/* Support Section */}
          <div className="flex flex-col">
            <h4 className="font-bold text-gray-900 mb-3 md:mb-4">Support</h4>
            <ul className="space-y-2">
              <li><a href="#" className="hover:underline hover:text-gray-900">Help Center</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Contact Us</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Cancellations</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Safety Info</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Report Issue</a></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:underline hover:text-gray-900">List Property</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Resources</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Community</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Hosting</a></li>
              <li><a href="#" className="hover:underline hover:text-gray-900">Partners</a></li>
            </ul>
          </div>
        </div>
