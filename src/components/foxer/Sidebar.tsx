  ...
  return (
    <div className={cn("flex h-full flex-col gap-2 bg-white dark:bg-card-dark", className)}>
      ...
      <div className="flex h-16 items-center border-b border-pink-100 px-6 dark:border-pink-900/30">
        <Link href="/foxerDashboard" className="flex items-center gap-2 font-semibold">
          ...
          <div>
            ...
            {openGroup === "platform" && (
              <div className="mt-1 space-y-1 pl-6">
                <NavItem href="/foxerDashboard" icon={<LayoutDashboard className="h-4 w-4" />} label="Dashboard" />
                <NavItem href="/foxerDashboard/bookings" icon={<CalendarDays className="h-4 w-4" />} label="Bookings" />
                <NavItem href="/foxerDashboard/settings" icon={<Settings className="h-4 w-4" />} label="Settings" />
              </div>
            )}
          </div>
