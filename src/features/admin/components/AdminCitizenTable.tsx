...
const ROLE_TYPE_STYLE: Record<string, { label: string; color: string; icon: string }> = {
  eventFoxer:   { label: 'Event Foxer',   color: 'bg-blue-500/10 text-blue-400 border-blue-500/20',     icon: 'storefront'  },
  ...
  venueFoxer:   { label: 'Venue Foxer',   color: 'bg-yellow-500/10 text-yellow-400 border-yellow-500/20', icon: 'star'        },
