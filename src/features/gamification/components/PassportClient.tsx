...
const PassportClient: React.FC<PassportClientProps> = ({ user }) => {
  ...
  const displayBadges = showAllBadges
    ? allBadges
    : allBadges.filter((b) => !b.path || activePathTypes.includes(b.path));
            ...
            <div className="relative z-20 mb-12 flex justify-between items-start">
              <div>
                ...
                <p className="text-white/40 text-sm font-medium tracking-wide">
                  {activeTab === "matches"
                    ? "Track your ranks and experiences."
                    : activeTab === "progress"
                      ? "Live stats and career path progress"
                      : "Your collection of unique event stamps"}
                </p>
              </div>
                  ...
                  <section>
                    ...
                    <div className="bg-white/2 border border-white/5 rounded-[3rem] p-8">
                      <BadgeGrid
                        ...
                        className={
                          showAllBadges ? "lg:grid-cols-6" : "lg:grid-cols-4"
                        }
