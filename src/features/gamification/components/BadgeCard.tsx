    ...
    >
      ...
      {!locked && (
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at 50% 0%, ${cfg.glow}80, transparent 70%)`,
          }}
        />
      )}
      ...
      <div className="relative z-10 text-center w-full">
        <h4
          className={`text-[11px] font-bold leading-tight mb-1.5 truncate px-1 ${locked ? "text-white/20" : "text-white"}`}
        >
          {badge.name || "???"}
        </h4>
        ...
        {/* Rarity */}
        <p
          className={`text-[9px] font-black uppercase tracking-[0.25em] mb-2 ${locked ? "text-white/10" : cfg.label}`}
        >
          {badge.rarity ?? "Common"}
        </p>
        ...
        {pathCfg && (
          ...
          >
            <span
              ...
              style={{
                background: locked ? "rgba(255,255,255,0.2)" : pathCfg.color,
              }}
            />
            <span
              className="text-[7px] font-black uppercase tracking-[0.2em]"
              style={{
                color: locked ? "rgba(255,255,255,0.2)" : pathCfg.color,
              }}
            >
              {pathCfg.label}
            </span>
