...
function FieldError({ msg }: { msg?: string }) {
  ...
  return (
    <span
      style={{ fontSize: 10, color: "#ef4444", marginTop: 3, display: "block" }}
    >
      {msg}
    </span>
  );
      ...
      >
        <div>
          <input
            ...
            style={errors.email ? FIELD_ERR : FIELD}
            autoComplete="email"
          />
        ...
        <div>
          <div style={{ position: "relative" }}>
            <input
              ...
              style={{
                ...(errors.password ? FIELD_ERR : FIELD),
                paddingRight: 48,
              }}
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            style={errors.username ? FIELD_ERR : FIELD}
        ...
        <div>
          ...
          {errors.password ? (
            ...
            >
              16+ chars · uppercase · lowercase · digit · special (@$!%*?&)
            </span>
          )}
        </div>
            ...
            style={{
              ...
              cursor:
                forgotMutation.isPending || !email.trim()
                  ? "not-allowed"
                  : "pointer",
              opacity: forgotMutation.isPending || !email.trim() ? 0.7 : 1,
              boxShadow: "0 4px 20px rgba(204,255,0,0.3)",
            }}
          >
...
function VerifyView({ onVerified }: { onVerified: () => void }) {
  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    verifyMutation.mutate(
      { email: pendingEmail, otpCode: otp },
      {
        onSuccess: () => {
          ...
          style={{
            ...
            cursor:
              verifyMutation.isPending || otp.length < 6
                ? "not-allowed"
                : "pointer",
            opacity: verifyMutation.isPending || otp.length < 6 ? 0.7 : 1,
            boxShadow: "0 4px 20px rgba(204,255,0,0.3)",
          }}
        >
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(204,255,0,0.08) 0%, transparent 70%)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      />
