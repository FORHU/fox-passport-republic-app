...
const CARD_BASE =
  "shrink-0 w-[65vw] max-w-60 sm:w-auto sm:max-w-none snap-center bg-surface-highlight/30 rounded-[2rem] sm:rounded-[2.5rem] p-2.5 sm:p-10 hover:bg-surface-highlight/50 transition-all duration-300 group border border-white/5";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            className={`${CARD_BASE} hover:border-cyan-500/50 hover:shadow-[0_0_30px_-5px_rgba(6,182,212,0.3)]`}
          >
            ...
            <h3 className="text-base sm:text-2xl font-display font-bold text-white mb-1.5 sm:mb-3">
              Verified Vibes Only
            </h3>
            <p className="text-sm sm:text-base text-text-muted leading-relaxed group-hover:text-white transition-colors">
              No catfishing here. We verify every foxer and venue so you can
              book with zero stress and 100% confidence.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm sm:text-base text-text-muted leading-relaxed group-hover:text-white transition-colors">
              Skip the DMs. Book your spot instantly and get your tickets
              directly to your phone. Fast, secure, easy.
            </p>
          </motion.div>
          ...
          <motion.div
            custom={2}
            variants={cardVariants}
            className={`${CARD_BASE} hover:border-pink-500/50 hover:shadow-[0_0_30px_-5px_rgba(236,72,153,0.3)]`}
          >
            ...
            <p className="text-sm sm:text-base text-text-muted leading-relaxed group-hover:text-white transition-colors">
              See who&apos;s going, join group chats, and make memories with
              people who match your energy perfectly.
            </p>
          </motion.div>
        </motion.div>
      </div>
