          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative">
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="glass-card rounded-[2rem] p-8 border border-white/10">
                ...
                <textarea className="w-full bg-black/20 border border-white/10 rounded-2xl p-4 text-white placeholder-text-muted/50 focus:border-accent focus:ring-1 focus:ring-accent transition-all resize-none h-32 outline-none" placeholder="Celebrating a birthday? Allergies? Let the organizer know..."></textarea>
              </div>
                </>
              )}
            </div>
