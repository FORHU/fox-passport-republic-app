          ...
          <div className="glass-panel rounded-[2.5rem] p-8 md:p-10 border border-white/10 shadow-xl relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-8">
              <div className="h-40 w-40 md:h-48 md:w-48 rounded-3xl overflow-hidden flex-shrink-0 border border-white/10 shadow-lg">
                {itemImage ? (
                  ...
                  <div className="h-full w-full bg-surface-highlight/50 flex items-center justify-center">
                    <span
                      className={`material-symbols-outlined text-[64px] ${typeColor} opacity-30`}
                    >
                      {typeIcon}
                    </span>
                  </div>
              ...
              <div className="flex-grow flex flex-col justify-center">
                <div
                  className={`font-bold text-xs mb-2 uppercase tracking-widest flex items-center gap-2 ${typeColor}`}
                >
                  <span
                    className={`h-2 w-2 rounded-full animate-pulse inline-block ${typeBadgeBg}`}
                  />
                ...
                {isService ? (
                  <>
                    <div className="flex items-start gap-3">
                      <div className="h-6 w-6 rounded-full bg-accent/20 border border-accent/30 flex items-center justify-center shrink-0 text-accent text-xs font-bold mt-0.5">
                        1
                      </div>
                      <p className="text-sm text-text-muted">
                        The provider reviews your project brief and confirms
                        availability.
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="h-6 w-6 rounded-full bg-white/5 border border-white/10 flex items-center justify-center shrink-0 text-white/40 text-xs font-bold mt-0.5">
                        2
                      </div>
                      <p className="text-sm text-text-muted">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm text-text-muted">
                        On the event day, confirm their arrival to release
                        payment.
                      </p>
                    </div>
                  </>
                  ...
                  <>
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm text-text-muted">
                        The owner verifies the equipment is available for your
                        dates.
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm text-text-muted">
                        Delivery or pickup coordinates are shared after
                        confirmation.
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                ...
                {bookingId && (
                  <button
                    onClick={() =>
                      router.push(
                        `/booking/fulfillment/${itemType}/${bookingId}`,
                      )
                    }
