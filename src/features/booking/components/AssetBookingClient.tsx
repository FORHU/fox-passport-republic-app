  ...
  const handleProceed = async () => {
    ...
    try {
      ...
      setBookingDetails({
        ...
        location:
          fulfillment === "delivery" ? deliveryAddress.trim() : "Pickup",
      });
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="glass-card rounded-[2rem] p-8 border border-white/10">
                ...
                <AvailabilityCalendar
                  ...
                  onEndChange={(d) => {
                    setEndDate(d);
                    if (d) setErrors((e) => ({ ...e, dates: undefined }));
                  }}
                ...
                {bookedRanges.length > 0 && (
                  <p className="text-[10px] text-white/30 mt-2 flex items-center gap-1">
                    ...
                    Fully-booked dates shown in red — increasing quantity may
              ...
              <div className="glass-card rounded-[2rem] p-8 border border-white/10 space-y-6">
                ...
                {fulfillment === "delivery" ? (
                  ...
                  <div className="flex items-start gap-3 px-4 py-3 bg-white/5 rounded-xl border border-white/10">
                    <span className="material-symbols-outlined text-accent text-[18px] mt-0.5 shrink-0">
                      info
                    </span>
                    <p className="text-sm text-text-muted">
                      You&apos;ll pick up and return the equipment directly from
                      the owner&apos;s location. Coordinates will be shared
                    ...
                    {[
                      {
                        ...
                        desc: "They verify the gear is available for your selected dates.",
                      },
                      {
                        icon: "lock",
                      ...
                      },
                      {
                        ...
                        desc: "Once you receive the gear in good condition, release payment.",
                      },
                    ].map((step, i) => (
                      <div key={i} className="flex gap-4">
                        <div className="flex flex-col items-center">
                          <div
                            className={`h-9 w-9 rounded-xl flex items-center justify-center shrink-0 ${i === 0 ? "bg-purple-400 text-black" : "bg-white/5 border border-white/10 text-white/40"}`}
                          >
                            <span className="material-symbols-outlined text-[18px]">
                              {step.icon}
                            </span>
                        ...
                        <div className="pb-5">
                          <p
                            className={`text-sm font-bold mb-0.5 ${i === 0 ? "text-purple-400" : "text-white/70"}`}
                          >
                            {step.title}
                          </p>
