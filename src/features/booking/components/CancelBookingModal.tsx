        ...
        {state.phase === "eligible" && (
          <div className="space-y-4">
            <p className="text-white/60 text-sm leading-relaxed">
              You are requesting to cancel this booking. Based on the
              cancellation policy, here is your refund estimate:
            </p>
            ...
            <div className="bg-white/5 rounded-xl p-5 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-accent font-bold">
                  {state.eligibleData.refundPercent}%
                </span>
              </div>
              ...
              <div className="bg-white/5 rounded-xl p-4 space-y-3">
                ...
                {state.refunds.some((r: any) => r.status === "failed") && (
                  <div className="bg-orange-500/10 border border-orange-500/20 rounded-xl p-3 flex items-start gap-2">
                    <span className="material-symbols-outlined text-orange-400 text-[16px] shrink-0 mt-0.5">
                      error_outline
                    </span>
                    <div>
                      <p className="text-orange-300 text-xs font-semibold">
                        Refund encountered an issue
                      </p>
                      <p className="text-orange-400/80 text-xs mt-0.5">
                        Our support team has been notified and will resolve this
                        within 3-5 business days. You don&apos;t need to do
                        anything.
                      </p>
                    </div>
                  </div>
            ...
            {state.refunds.length === 0 && (
              <div className="bg-white/5 rounded-xl p-4">
                <p className="text-text-muted text-sm text-center">
                  No refunds were processed for this cancellation.
                </p>
              </div>
            )}
