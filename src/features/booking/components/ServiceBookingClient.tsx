...
import { bookService, fetchServiceAvailability } from '@/features/booking/api/bookings';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative">
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="glass-card rounded-[2rem] p-8 border border-white/10">
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-text-muted font-bold ml-1">
                    Call Time
                    <span className="ml-2 text-[10px] text-text-muted normal-case font-normal">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between bg-black/20 p-3 rounded-2xl border border-white/5">
                      <button
                        onClick={() =>
                          setGuestCount(Math.max(1, guestCount - 10))
                        }
                        className="h-11 w-11 rounded-xl bg-surface-highlight text-white hover:bg-white/10 flex items-center justify-center transition-colors"
                      >
                        <span className="material-symbols-outlined text-[18px]">
              ...
              <div className="glass-card rounded-[2rem] p-8 border border-white/10 space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-text-muted font-bold ml-1">
                    Project Brief / Special Requests
                  </label>
                  <textarea
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    {!isPerSession && (
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-white font-medium">
                          {durationHours} {durationLabel.toLowerCase()}
                        </span>
                      </div>
                    )}
                    {sessionCount > 1 && (
                    ...
                    {[
                      {
                        ...
                        desc: "They confirm your project brief and lock in your date.",
                      },
                      {
                        icon: "lock",
                      ...
                      {
                        icon: "where_to_vote",
                        title: "Confirm Their Arrival",
                        desc: "On event day, tap Confirm Arrival to release payment.",
                      },
                    ].map((step, i) => (
                      <div key={i} className="flex gap-4">
                        <div className="flex flex-col items-center">
                          <div
                            className={`h-9 w-9 rounded-xl flex items-center justify-center shrink-0 ${i === 0 ? "bg-orange-400 text-black" : "bg-white/5 border border-white/10 text-white/40"}`}
                          >
                            <span className="material-symbols-outlined text-[18px]">
                              {step.icon}
                            </span>
                        ...
                        <div className={`pb-5 ${i < 2 ? "" : ""}`}>
                          <p
                            className={`text-sm font-bold mb-0.5 ${i === 0 ? "text-orange-400" : "text-white/70"}`}
                          >
                            {step.title}
                          </p>
