      ...
      <div className="min-h-screen bg-background bg-gradient-dark flex items-center justify-center text-center p-8">
        <div>
          ...
          <p className="text-text-muted mb-6">
            No booking information found. Please start from the venue page.
          </p>
          <Link
            href="/"
      ...
      <main className="grow pt-32 pb-28 sm:pb-20 relative">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div>
                ...
                <p className="text-text-muted mt-2">
                  Complete your secure payment to confirm the venue booking.
                </p>
              </div>
              <ProgressIndicator
                steps={[
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
                ...
                <Elements stripe={stripePromise} options={elementsOptions}>
                    ...
                    {paymentSuccess ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-text-muted text-sm">
                          Your venue booking is all set. We&apos;ve sent the
                  ...
                  {paymentSuccess && (
                    <div className="flex gap-3 justify-center pt-4">
                      <Link
                        href="/booking"
                        className="px-8 py-4 rounded-xl border border-white/10 text-white font-bold text-sm hover:bg-white/5 transition-all"
                      >
                        View Bookings
                      </Link>
                      <Link
                        href="/"
                        className="px-8 py-4 rounded-xl bg-accent text-black font-bold text-sm hover:shadow-[0_0_20px_rgba(204,255,0,0.4)] transition-all flex items-center gap-2"
                      >
                        Return Home
            ...
            {/* Order Summary */}
            <div
              className="lg:col-span-4 reveal-on-scroll"
                ...
                <div className="bg-surface-highlight/30 rounded-3xl p-6 border border-white/5 flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-white font-bold font-display text-sm mb-1">
                      FoxPassport Guarantee
                    </h4>
                    <p className="text-xs text-text-muted leading-relaxed">
                      Your booking is protected. If the vibe isn&apos;t as
                      described, we&apos;ve got your back with a full refund
