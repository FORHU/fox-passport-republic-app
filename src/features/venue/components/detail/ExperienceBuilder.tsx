...
export function CustomExperienceBuilder({
  isOpen,
  onClose,
  venuePrice,
              ...
              {isLoading ? (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                  {[...Array(3)].map((_, i) => (
                    <div
                      key={i}
                      className="rounded-[2rem] p-6 border border-white/5 bg-white/5 animate-pulse space-y-4"
                    >
                ...
                <div className="flex flex-col items-center justify-center py-20 text-center">
                  ...
                  <p className="text-text-muted text-sm">
                    No foxers available yet.
                  </p>
                  <p className="text-white/20 text-xs mt-1">
                    Check back once foxers are approved.
                  </p>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
