...
const IMAGES = {
  ...
  hiking: [
    ...
    "https://images.unsplash.com/photo-1445112098124-3e76dd67983c?auto=format&fit=crop&w=800&q=80",
  ...
  paragliding: [
    ...
    "https://images.unsplash.com/photo-1533692328991-08159ff19c34?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1605540436563-5bca919ae766?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1509032842883-e9d0d97f0d3e?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1534329539061-64caeb388c42?auto=format&fit=crop&w=800&q=80",
  ],
  diving: [
    ...
    "https://images.unsplash.com/photo-1621274403997-37aace184f49?auto=format&fit=crop&w=800&q=80",
  ],
  surfing: [
    "https://images.unsplash.com/photo-1502933691298-84fc14542831?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1559827260-dc66d52bef19?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1470114716159-e389f8712fda?auto=format&fit=crop&w=800&q=80",
  ...
  ziplining: [
    ...
    "https://images.unsplash.com/photo-1452741446081-bb5a9e79d6c7?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1476610182048-b716b8518aae?auto=format&fit=crop&w=800&q=80",
    "https://images.unsplash.com/photo-1533619043865-1c2e2fbbfe15?auto=format&fit=crop&w=800&q=80",
  ],
};
...
const VENUE_TEMPLATES: VenueTemplate[] = [
  ...
  {
    titlePrefix: "Mountain Hiking Trail",
    category: "Hiking Experience",
    images: IMAGES.hiking,
    descriptionTemplate:
      "Embark on an unforgettable hiking adventure through scenic trails in {location}.",
    offers: [
      "Trail Guide",
      "Safety Gear",
      "First Aid Kit",
  ...
  {
    titlePrefix: "Paragliding Adventure",
    category: "Paragliding Experience",
    images: IMAGES.paragliding,
    descriptionTemplate:
      "Soar through the skies and experience breathtaking aerial views in {location}.",
    offers: [
      "Professional Pilot",
      "Safety Equipment",
      "Video Recording",
  ...
  {
    titlePrefix: "Scuba Diving Center",
    category: "Diving Experience",
    images: IMAGES.diving,
    descriptionTemplate:
      "Explore the underwater world with professional diving experiences in {location}.",
    offers: [
      "Diving Equipment",
      "Instructor",
      "Boat Transfer",
  ...
  {
    titlePrefix: "Surf Camp",
    category: "Surfing Experience",
    images: IMAGES.surfing,
    descriptionTemplate:
      "Catch the perfect wave and learn to surf at this amazing surf camp in {location}.",
    offers: [
      "Surf Lessons",
      "Board Rental",
      "Wetsuit",
  ...
  {
    titlePrefix: "Zip-line Adventure Park",
    category: "Zip-lining Experience",
    images: IMAGES.ziplining,
    descriptionTemplate:
      "Experience an adrenaline rush as you zip through the canopy in {location}.",
    offers: [
      "Safety Harness",
      "Helmet",
      "Gloves",
