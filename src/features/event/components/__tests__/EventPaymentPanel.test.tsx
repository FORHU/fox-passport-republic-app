...
describe("EventPaymentPanel", () => {
  ...
  it("Pay Now triggers checkout mutation", () => {
    ...
    expect(mockCheckout).toHaveBeenCalledWith({ eventId: "event-123", voucherCode: undefined });
  });
  ...
  it("disables button while loading", () => {
    ...
    render(<EventPaymentPanel eventId="event-123" />);
    const button = screen.getByRole("button", { name: /Redirecting to secure checkout/i });
