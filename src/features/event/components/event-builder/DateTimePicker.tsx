      ...
      >
        ...
        <div className="grid grid-cols-7 px-3 mb-1">
          {DAYS.map((d) => (
            <div
              key={d}
              className="text-center text-[10px] font-bold text-white/25 py-1"
            >
              {d}
            </div>
          ))}
        ...
        <div className="border-t border-white/5 px-4 py-3 flex items-center gap-3">
          <span className="text-[10px] font-bold text-white/30 uppercase tracking-wider mr-1">
            Time
          </span>
        ...
        <div className="border-t border-white/5 px-4 py-2.5 flex justify-between">
          ...
          <button
            type="button"
            onClick={handleToday}
            className="text-xs text-accent font-bold hover:text-white transition-colors"
          >
            Today
          </button>
        </div>
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span
          className={`text-sm flex-1 ${displayLabel ? "text-white" : "text-white/30"}`}
        >
