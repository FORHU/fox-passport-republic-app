...
export default function MobilePassportHeader({ user }: MobilePassportHeaderProps) {
  return (
    <div
      style={{ background: '#050608', position: 'relative', overflow: 'hidden', paddingBottom: 24 }}
    >
      ...
      <div
        style={{
          ...
          right: 0,
          height: 300,
          background: 'radial-gradient(circle at 30% 0%, rgba(204,255,0,0.10), transparent 70%)',
          pointerEvents: 'none',
        }}
      />
      ...
      <div style={{ padding: '0 20px 20px' }}>
        <PassportBookletCard user={user} citizenNo={user?.citizenId ?? undefined} />
      </div>
        ...
        {STAMPS.map((stamp) => (
          ...
          >
            ...
            <span
              style={{
                fontSize: 9,
                color: stamp.collected ? 'rgba(204,255,0,0.7)' : 'rgba(255,255,255,0.2)',
        ...
        >
          <div className="flex items-center justify-between" style={{ marginBottom: 10 }}>
            <div className="flex items-center gap-2">
              ...
              <span style={{ fontSize: 13, fontWeight: 600, color: '#fff' }}>Night Owl</span>
            </div>
            <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>3 / 5 events</span>
          </div>
          {/* Progress bar */}
          <div
            style={{
