      ...
      {venues.length > 0 && (
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
            ...
            <Link
              href="/venues"
              className="text-sm text-accent hover:underline font-medium whitespace-nowrap"
            >
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {venues.slice(0, 4).map((venue) => {
              const hasRealImg =
                venue.img && venue.img !== "/herobackground.jpg";
              return (
                <Link
                  key={venue.id}
                ...
                >
                  <article className="glass-card group relative flex flex-col rounded-[2rem] overflow-hidden card-hover-effect cursor-pointer">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-text-muted text-xs mb-3 line-clamp-1">
                        {venue.loc || venue.location || "—"}
                      </p>
                      <div className="flex items-center justify-between">
