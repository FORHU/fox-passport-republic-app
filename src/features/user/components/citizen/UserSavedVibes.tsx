      ...
      <div className="glass-panel rounded-[2.5rem] p-6 flex flex-col flex-1 h-full">
                {savedVibes.length === 0 ? (
                  <div className="flex flex-col items-center justify-center flex-1 py-8 text-center">
                    <span className="material-symbols-outlined text-4xl text-white/20 mb-3">favorite</span>
                    <p className="text-sm font-bold text-white/40 mb-1">No saved vibes yet</p>
                    <p className="text-xs text-text-muted">Bookmark events and venues to see them here.</p>
                  </div>
                ) : (
