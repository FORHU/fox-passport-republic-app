...
export const BidApplicationModal: React.FC<BidApplicationModalProps> = ({
  eventId,
  isOpen,
  onClose,
  onSuccess,
      ...
      <div className="glass-card relative rounded-2xl border border-white/10 p-6 w-full max-w-md z-10 animate-in fade-in zoom-in-95">
        ...
        <div className="flex justify-end gap-3 mt-6">
          <button
            ...
            className="px-4 py-2 rounded-full border border-white/10 hover:bg-white/5 transition-colors text-white/70"
          >
            Cancel
          </button>
          <button
