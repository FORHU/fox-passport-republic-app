  ...
  return (
    <div className="mb-12 sm:mb-20 relative overflow-hidden">
      ...
      <div className="hidden">
        from-lime-300 via-green-400 to-emerald-500 from-pink-300 via-rose-400
        to-red-400 from-amber-200 via-yellow-400 to-orange-500 from-emerald-400
        via-teal-500 to-cyan-500 from-indigo-400 via-purple-500 to-pink-500
      </div>

      {/* Glow Effect */}
      <div
        className={`absolute -top-32 -left-20 w-[500px] h-[500px] bg-linear-to-br ${gradientColors} rounded-full blur-[150px] opacity-30 pointer-events-none`}
      ></div>
      ...
      <div className="relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="flex items-center gap-2 mb-2 text-xs font-bold tracking-wider uppercase text-gray-500">
          ...
          <span
            className={`inline-block text-transparent bg-clip-text bg-linear-to-r ${gradientColors}`}
          >
