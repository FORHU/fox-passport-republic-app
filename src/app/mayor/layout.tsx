...
/**
 * Signed-in only: applying to be a mayor, and creating a venue.
 *
 ...
 *
 * `requireAuth` and not `requireHost`: `/mayor/apply` is how someone becomes
 * one, so gating it on already being one would lock out the people it is for.
 */
export default async function MayorLayout({
  children,
}: {
